...
class Clair3_Trio_Out3(tf.keras.Model):
    ...
    def __init__(self, add_indel_length=False, predict=False, is_padding=False, add_mcv_loss=False):
        ...
        self.res_block1 = make_basic_block_layer_trio(filter_num=64,
                                            blocks=1, stride=1, SeparableConv=False)
        ...
        self.res_block2 = make_basic_block_layer_trio(filter_num=128,
                                            blocks=1, stride=1, SeparableConv=False)
        ...
        self.conv7 = BasicConv2D(filters=512,
                                 ...
                                 strides=2,
                                 padding="same")
        self.res_block4 = make_basic_block_layer_trio(filter_num=512,
                                                 blocks=1, stride=1)
