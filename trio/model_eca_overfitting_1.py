...
class BasicBlock_attention(tf.keras.layers.Layer):
...
def make_basic_block_layer_attention(filter_num, blocks, stride=1, SeparableConv=False):

    res_block = tf.keras.Sequential()

    res_block.add(BasicBlock_attention(filter_num, stride=stride, SeparableConv=SeparableConv))

    for _ in range(1, blocks):
        res_block.add(BasicBlock_attention(filter_num, stride=1,SeparableConv=SeparableConv))
...
class Clair3_Trio_Basic(tf.keras.Model):
    ...
    def __init__(self, add_indel_length=False, predict=False, is_padding=False):
        ...
        self.res_block2 = make_basic_block_layer_attention(filter_num=128,
                                            blocks=1, stride=1, SeparableConv=False)
        ...
        self.res_block3 = make_basic_block_layer_attention(filter_num=256,
                                            blocks=1, stride=1)
...
class Clair3_Trio_V_o1_rres(tf.keras.Model):
    ...
    def __init__(self, add_indel_length=False, predict=False):
        ...
        self.res_block4 = make_basic_block_layer_attention(filter_num=512,
                                            blocks=1, stride=1)
