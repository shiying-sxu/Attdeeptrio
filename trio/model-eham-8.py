...
class SpatialAttention_F(tf.keras.layers.Layer):
    def __init__(self, kernel_size=7):
        ...
        self.conv1 = tf.keras.layers.Conv2D(1, kernel_size=kernel_size, strides=1, padding='same',
                                            kernel_regularizer=tf.keras.regularizers.l2(1e-4),
                                            use_bias=True, activation=tf.nn.gelu)
        self.conv2 = tf.keras.layers.Conv2D(1, kernel_size=kernel_size, strides=1, padding='same',
                                            kernel_regularizer=tf.keras.regularizers.l2(1e-4),
                                            use_bias=True)
