...
if [ ! -d ${MODEL_PATH_C3} ]; then echo -e "${ERROR} Model path not found for clair3${NC}"; exit 1; fi
if [ ! -d ${MODEL_PATH_C3T} ]; then echo -e "${ERROR} Model path not found for trio${NC}"; exit 1; fi
